...
if(isset($_POST['change'])){
   ...
   $query="SELECT *FROM loginform where name='$name' AND email='$email'";

   $result=mysqli_query($conn,$query);
   $num=mysqli_fetch_array($result);
   if($num>0){
       mysqli_query($conn,"update loginform set password='$pwd' WHERE email='$email' AND name='$name'");
    ...
    <footer class="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="arrow">
                    <a href="forget.php"><img src="image/arrow.png"></a>
                </div>
            </div>
