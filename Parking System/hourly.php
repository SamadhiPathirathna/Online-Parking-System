...
<header>
    ...
    <center>
	     ...
	     <button class="btn1" type="button" id="btn1" onclick="loadData('btn1')">Hourly </button>
    ...
    <hr>
   <center>
   <h3> Hourly Parking Reservations</h3>
   </center>
...
<hr>
     ...
     <button id="bt1" name="submit" onclick="location.href='hcheap.html';">Cheapest</button>
</div>
			  ...
			  while($row=mysqli_fetch_assoc($result))
			  {
                ...
                <div class="img">
				 ...
				 <div class="list-desc">
                    ...
                    <h4><?php echo $name?></h4>
                    <p class="price"><?php echo $price1?></p>
                    <p class="detail"><?php echo $desc?><br>
					   
					   <a href="index.html"><button class="btnn" onclick="#">Book Now</button></a><br>
				<?php
		  }}
				?>
